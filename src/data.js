...
export const days = [
  {
    ...
    subtitle: '논문 리뷰부터 제안서 초안, 개인 연구용 Project 구축까지',
    sessions: [
      { time: '10:00–11:30', title: '오리엔테이션 & Claude 기초', desc: '계정·환경 설정, 프롬프트 기본기, 안전한 활용 원칙' },
      { time: '11:30–13:00', title: '논문 PDF 기반 연구 리뷰 매트릭스', desc: 'PDF 업로드 → 핵심 추출 → 비교 매트릭스 자동 작성' },
      { time: '14:00–15:30', title: '데이터 분석 리포트 작성', desc: '데이터 요약·시각화 해설·인사이트 도출 리포트 만들기' },
      { time: '15:45–17:00', title: '연구 공고문 기반 제안서 초안', desc: '공고문 분석 → 요건 매핑 → 제안서 구조 초안 생성' },
      { time: '17:00–18:00', title: '개인 연구 업무용 Claude Project 구축', desc: '본인 연구 맥락을 담은 전용 Project 세팅·실습' },
    ],
  },
  {
    day: 'Day 2', date: '6.25 THU', accent: '#C2603D', headBg: '#FBF3EC', chipBg: '#F3E1D5',
    title: 'AX 브릿지 교과목 설계',
    subtitle: '담당 교과목에 AI를 접목하고 과목 에이전트를 만들기',
    sessions: [
      { time: '10:00–11:30', title: '교과목 AI 접목 아이디어 도출', desc: '담당 과목 진단 → AI 활용 지점 발굴 워크숍' },
      { time: '11:30–13:00', title: 'AI 활용 PBL 과제 설계', desc: '문제기반학습 시나리오와 평가 루브릭 설계서 작성' },
      { time: '14:00–15:30', title: '과목·연구 에이전트 구축', desc: 'Claude Project 기반 과목 전용 에이전트 만들기' },
      { time: '15:45–17:00', title: '튜터 지침 작성 실습', desc: '학생 응대 규칙·범위·말투를 담은 튜터 지침서 작성' },
      { time: '17:00–18:00', title: '공유 & 마무리', desc: '산출물 발표, 현업 적용 계획, Q&A' },
    ],
  },
]
